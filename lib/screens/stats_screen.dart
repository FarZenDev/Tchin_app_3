            ...
            children: [
               ...
               ClipPath(
                 ...
                 child: Container(
                   ...
                   margin: const EdgeInsets.symmetric(horizontal: 0), // Removed extra margin
                   padding: const EdgeInsets.fromLTRB(16, 40, 16, 50), // Reduced horizontal padding
                   ...
                   child: Column(
                     ...
                     children: [
                       // Logo / Header
                       const Center(
                         child: Icon(Icons.receipt_long, color: Colors.black87, size: 40),
                       ),
                       ...
                       if (sortedPlayers.isEmpty)
                         Center(child: Text("Rien à payer...", style: GoogleFonts.courierPrime(color: Colors.black))),
                             ...
                             children: [
                               Expanded(
                                 child: Text(
                                   ...
                                   style: GoogleFonts.courierPrime(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.black87),
                       ...
                       Row(
                         mainAxisAlignment: MainAxisAlignment.spaceBetween,
                         children: [
                           Text("TOTAL", style: GoogleFonts.courierPrime(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.black)),
                           Text("$totalSips GORGÉES", style: GoogleFonts.courierPrime(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.black)),
                         ],
                       ),
                       ...
                       Center(
                         child: Text(
                           ...
                           style: GoogleFonts.courierPrime(fontSize: 14, fontStyle: FontStyle.italic, color: Colors.black54),
                         ),
                       ),
                       const SizedBox(height: 10),
                       // Barcode fake
                       Container(
                         ...
                         child: const Center(child: Text("||| || ||||| ||| ||", style: TextStyle(fontFamily: 'monospace', letterSpacing: 4))),
                       )
                     ],
                   ),
                 ),
